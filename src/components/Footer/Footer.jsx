  ...
  <footer>
    ...
    >
      ...
      <div className="license-text">
        ...
        have waived all copyright and related or neighboring rights to any
        content I have created for{' '}
        <span property="dct:title">jaywiggins.com</span>. This work is published
        from:{' '}
        <span
